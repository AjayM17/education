            ...
            <div className="row background section">
                ...
                <div className="col-md-9">
                    ...
                    <form style={{ marginTop: '16px' }}>
                        ...
                        <div className="form-group row">
                            <label className="col-3 col-form-label">Father's/Mother's Name</label>
                            <div className="col-6">
                                <input type="text" className="form-control" />
                            </div>
                        </div>
                        ...
                        <div className="form-group row">
                            <label className="col-3 col-form-label">Education Qualification</label>
                            <div className="col-6">
                                <input type="text" className="form-control" />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-3 col-form-label">Courses of Interest</label>
                            <div className="col-6">
                        ...
                        <div className="form-group row">
                            <label className="col-3 col-form-label">Your Query</label>
                            <div className="col-6">
