    ...
    return (
        <div className="header">
            ...
            <ul className="list d-flex flex-lg-row flex-column justify-content-between ">
                ...
                <li className={"list-item "  + (active === 'message' ? 'active' : '')} onClick={() => { setActive('message'); history.push('/message') }}>Direct Message</li>
                <li className={"list-item "  + (active === 'gallery' ? 'active' : '')} onClick={() => { setActive('gallery'); history.push('/gallery') }}>Gallary</li>
